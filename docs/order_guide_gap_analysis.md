...
This app can compare imported order guide rows against receipt-backed products.
...
- Count a product as covered when it is linked to an active guide row or has an explicit conservative plain-language match.
