module Purchasing
  class CategoryClassifier
    RULES = {
      ...
      "Meat" => /\b(BACON|HAM|PASTRAMI|CORNED|TRKY|TURKEY|TKY|BURGER|CHIX|FZSAU|SAU\s|SAUS|SAUSAGE|BF\s)\b/i,
      ...
      "Paper goods" => /\b(PAPER|TOWEL|TWL|NAPKIN|BAG WHT|CHECKS|ROLL|WAX PPR|WAX)\b/i,
      "Packaging" => /\b(LID|CUP|CONTAINER|CONT|CLAM|LINER|SOUF|STRAW|STRW|WRAP|FOIL|PLATE|BOWL|LABEL|BAG POLY|KIT FKSN|CUTLERY|DOMINION|DESSRT SP|SMILEFACE)\b|BAG PL/i,
