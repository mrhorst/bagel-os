module ApplicationHelper
  ...
  MODULES = [
    ...
    { key: :follow_ups,     label: "Follow-ups",   hub: :shift,  icon: "alert",     path_helper: :follow_ups_path,         controllers: %w[follow_ups],                                                                       module_name: "follow_ups",            description: "Flagged issues that still need attention." },
