module ApplicationHelper
  ...
  MODULES = [
    ...
    { key: :follow_ups,     label: "Follow-ups",   hub: :shift,  icon: "flag",      path_helper: :follow_ups_path,         controllers: %w[follow_ups],                                                                       module_name: "follow_ups",            description: "Flagged issues that still need attention." },
    ...
    { key: :recipes,        label: "Recipes",      hub: :stock,  icon: "book",      path_helper: :recipes_path,            controllers: %w[recipes recipe_ingredients],                       module_name: "recipes",              description: "House recipes that use your inventory items." },
    { key: :products,       label: "Products",     hub: :stock,  icon: "package",   path_helper: :products_path,           controllers: %w[products product_order_guide_memberships],         module_name: "products",             description: "The master catalog of everything purchased." },
    ...
    { key: :review,         label: "Review",       hub: :more,   icon: "search",    path_helper: :normalization_reviews_path, controllers: %w[normalization_reviews],                         module_name: "normalization_reviews", description: "Resolve uncertain receipt and product matches." },
    ...
    { key: :account,        label: "Account",      hub: :more,   icon: "user-circle", path_helper: :account_path,          controllers: %w[accounts passwords sessions],                                                           description: "Your profile, password, and sign out." }
  ].freeze
  ...
  def nav_icon(name)
    paths = {
      ...
      "flag" => tag.path(d: "M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1zM4 22v-7", "stroke-linecap": "round", "stroke-linejoin": "round"),
      "search" => tag.path(d: "M11 19a8 8 0 1 0 0-16 8 8 0 0 0 0 16ZM21 21l-4.35-4.35", "stroke-linecap": "round", "stroke-linejoin": "round"),
      ...
      "user-circle" => tag.path(d: "M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-9.2a2.8 2.8 0 1 0 0-5.6 2.8 2.8 0 0 0 0 5.6Zm-5.2 6.5a5.4 5.4 0 0 1 10.4 0", "stroke-linecap": "round", "stroke-linejoin": "round"),
