module ApplicationHelper
  ...
  MODULES = [
    ...
    { key: :recipes,        label: "Recipes",      hub: :stock,  icon: "book",      path_helper: :recipes_path,            controllers: %w[recipes],                                          module_name: "recipes",              description: "House recipes that use your inventory items." },
